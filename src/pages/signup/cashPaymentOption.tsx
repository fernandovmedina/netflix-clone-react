            ...
            <section className="w-full flex items-center justify-center">
                <div className="flex flex-col w-[30%] py-12">
                    ...
                    <h4 className="text-base">
                        Your number will also be used in case you forget your password
                        and for important account messages. SMS rates may apply.
                    </h4>
                    <form action="" method="post" className="my-6">
                        ...
                        <div className="text-gray-400 text-xs">
                            <p>
                                ...
                                fee (currently $99 per month + applicable taxes) through
                        ...
                        <div className="flex items-center my-2">
                            ...
                            <h4 className="mx-2 text-base" id="chk">I ACCEPT</h4>
                        </div>
                        <button
                            type="button"
