...
CREATE TABLE IF NOT EXISTS SERIES_BACKGROUNDS (
    ...
    CONSTRAINT PK_BACKGROUNDS PRIMARY KEY (ID_SBACKGROUND),
    SOURCE TEXT NULL,
    ID_SERIE INT NULL,
...
CREATE TABLE IF NOT EXISTS MOVIES_BACKGROUNDS (
    ...
    CONSTRAINT PK_BACKGROUNDS PRIMARY KEY (ID_MBACKGROUND),
    SOURCE TEXT NULL,
    ID_MOVIE INT NULL,
...
CREATE TABLE IF NOT EXISTS CHAPTERS_BACKGROUNDS (
    ...
    CONSTRAINT PK_BACKGROUNDS PRIMARY KEY (ID_CBACKGROUND),
    SOURCE TEXT NULL,
    ID_CHAPTER INT NULL,
...
CREATE TABLE IF NOT EXISTS PAYMENT_METHODS (
    ID_PAYMENT_METHOD INT AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS PAYMENTS (
    ...
    ID_ACCOUNT INT NOT NULL,
    CONSTRAINT FK_PAYMENTS_TO_ACCOUNTS FOREIGN KEY (ID_ACCOUNT) REFERENCES ACCOUNTS (ID_ACCOUNT),
    ID_PAYMENT_METHOD INT NULL,
    CONSTRAINT FK_PAYMENTS_TO_PAYMENT_METHODS FOREIGN KEY (ID_PAYMENT_METHOD) REFERENCES PAYMENT_METHODS (ID_PAYMENT_METHOD)
);

CREATE TABLE IF NOT EXISTS CARD_PAYMENTS (
    ID_CARD_PAYMENT INT AUTO_INCREMENT NOT NULL,
    CONSTRAINT PK_CARD_PAYMENTS PRIMARY KEY (ID_CARD_PAYMENT),
    CARD_NAME TEXT NULL,
    CARD_NUMBER TEXT NULL,
    CARD_DUE_DATE TEXT NULL,
    CARD_CVV INT NULL,
    ID_PAYMENT INT NOT NULL,
    CONSTRAINT FK_CARD_PAYMENTS_TO_PAYMENTS FOREIGN KEY (ID_PAYMENT) REFERENCES PAYMENTS (ID_PAYMENT)
);

CREATE TABLE IF NOT EXISTS OXXO_ADS_CODES (
    ID_OXXO_ADD_CODE INT AUTO_INCREMENT NOT NULL,
    CONSTRAINT PK_OXXO_ADS_CODES PRIMARY KEY (ID_OXXO_ADD_CODE),
    VALUE TEXT NULL
);

CREATE TABLE IF NOT EXISTS OXXO_STANDARD_CODES (
    ID_OXXO_STANDARD_CODE INT AUTO_INCREMENT NOT NULL,
    CONSTRAINT PK_OXXO_STANDARD_CODES PRIMARY KEY (ID_OXXO_STANDARD_CODE),
    VALUE TEXT NULL
);

CREATE TABLE IF NOT EXISTS OXXO_PREMIUM_CODES (
    ID_OXXO_PREMIUM_CODE INT AUTOM_INCREMENT NOT NULL,
    CONSTRAINT PK_OXXO_PREMIUM_CODES PRIMARY KEY (ID_OXXO_PREMIUM_CODE),
    VALUE TEXT NULL
);

CREATE TABLE IF NOT EXISTS OXXO_PAYMENTS (
    ID_OXXO_PAYMENT INT AUTO_INCREMENT NOT NULL,
    CONSTRAINT PK_OXXO_PAYMENTS PRIMARY KEY (ID_OXXO_PAYMENT),
    PHONE_NUMBER TEXT NULL,
    NAME TEXT NULL,
    ID_PAYMENT INT NOT NULL,
    CONSTRAINT FK_OXXO_PAYMENTS_TO_PAYMENTS FOREIGN KEY (ID_PAYMENT) REFERENCES PAYMENTS (ID_PAYMENT)
);

CREATE TABLE IF NOT EXISTS GIFT_CODE_PAYMENTS (
    ID_GIFT_CODE_PAYMENT INT AUTO_INCREMENT NOT NULL,
    CONSTRAINT PK_GIFT_CODE_PAYMENTS PRIMARY KEY (ID_GIFT_CODE_PAYMENT),
    ID_CODE INT NOT NULL,
    CONSTRAINT FK_GIFT_CODE_PAYMENTS_TO_GIFT_CODES FOREIGN KEY (ID_CODE) REFERENCES GIFT_CODES (ID_CODE),
    ID_PAYMENT INT NOT NULL,
    CONSTRAINT FK_GIFT_CODE_PAYMENTS_TO_PAYMENTS FOREIGN KEY (ID_PAYMENT) REFERENCES PAYMENTS (ID_PAYMENT)
);
