...
CREATE TABLE IF NOT EXISTS OXXO_CODES (
  ID_OXXO_CODE INT AUTO_INCREMENT NOT NULL,
  CONSTRAINT PK_OXXO_CODES PRIMARY KEY (ID_OXXO_CODE),
  VALUE TEXT NULL,
  SOURCE TEXT NULL,
  ID_ACCOUNT INT NOT NULL,
  CONSTRAINT FK_OXXO_CODES_TO_ACCOUNTS FOREIGN KEY (ID_ACCOUNT) REFERENCES ACCOUNTS (ID_ACCOUNT)
);
...
CREATE TABLE IF NOT EXISTS OXXO_PAYMENTS (
    ...
    NAME TEXT NULL,
    ID_OXXO_CODE INT NULL,
    CONSTRAINT FK_OXXO_PAYMENTS_TO_OXXO_CODES FOREIGN KEY (ID_OXXO_CODE) REFERENCES OXXO_CODES (ID_OXXO_CODE),
    ID_PAYMENT INT NOT NULL,
